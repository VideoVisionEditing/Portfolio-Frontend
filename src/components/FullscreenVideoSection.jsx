...
const ReelVideo = ({ src }) => {
  ...
  return (
    <div className="h-[100dvh] w-full flex-shrink-0 snap-start relative bg-black flex items-center justify-center overflow-hidden mb-8 md:mb-0">
      <video
        ref={videoRef}
        src={src}
...
const FullscreenVideoSection = ({ reelIndex }) => {
  ...
  const mobileVideos = [
    "/Website/Reel Edits/Iphone Video Mockup 1.mp4",
    "/Website/Reel Edits/Iphone Video Mockup 2.mp4",
    "/Website/Reel Edits/Iphone Video Mockup 3.mp4"
  ];
  ...
  return (
    <section className="h-screen w-full relative overflow-hidden bg-black flex items-center justify-center">
      ...
      <div className="absolute inset-0 opacity-40 blur-3xl scale-110 pointer-events-none overflow-hidden">
        <video
          ref={bgVideoRef}
          data-src="/Website/Reel Edits/Iphone Video Mockup reel editing.mp4"
