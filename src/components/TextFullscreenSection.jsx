...
const TextFullscreenSection = ({ reelIndex }) => {
  ...
  const mobileVideos = [
    "/Website/Text Animation/Iphone Video Mockup broadcast 1.mp4",
    "/Website/Text Animation/Iphone Video Mockup broadcast 2.mp4",
    "/Website/Text Animation/Iphone Video Mockup broadcast 3.mp4"
  ];
  ...
  return (
    <section className="h-screen w-full relative overflow-hidden bg-black flex items-center justify-center">
      ...
      <div className="absolute inset-0 opacity-40 blur-3xl scale-110 pointer-events-none overflow-hidden">
        <video
          ref={bgVideoRef}
          data-src="/Website/Text Animation/Iphone Video Mockup Text Animation.mp4"
      ...
      >
        <video
          ref={mainVideoRef}
          src="/Website/Text Animation/Iphone Video Mockup Text Animation.mp4"
...
export default TextFullscreenSection;
