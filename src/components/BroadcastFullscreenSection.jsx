...
const BroadcastFullscreenSection = ({ reelIndex }) => {
  ...
  const mobileVideos = [
    "/Website/broadcast/Iphone Video Mockup 1.mp4",
    "/Website/broadcast/Iphone Video Mockup 2.mp4",
    "/Website/broadcast/Iphone Video Mockup 3.mp4"
  ];
  ...
  return (
    <section className="h-screen w-full relative overflow-hidden bg-black flex items-center justify-center">
      ...
      <div className="absolute inset-0 opacity-40 blur-3xl scale-110 pointer-events-none overflow-hidden">
        <video
          ref={bgVideoRef}
          data-src="/Website/broadcast/Iphone Video Mockup broadcast.mp4"
      ...
      >
        <video
          ref={mainVideoRef}
          src="/Website/broadcast/Iphone Video Mockup broadcast.mp4"
...
export default BroadcastFullscreenSection;
