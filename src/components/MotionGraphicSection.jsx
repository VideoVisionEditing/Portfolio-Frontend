  ...
  return (
    <section className="min-h-[100dvh] h-auto w-full bg-black text-white flex items-start lg:items-center justify-center relative border-y border-white/5 pt-[50px] pb-[30px] lg:py-0">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-20">
        <div className="absolute top-0 right-0 w-[40vw] h-[40vw] bg-[#E5203A] rounded-full blur-[150px] -translate-y-1/2 translate-x-1/2" />
        <div className="absolute bottom-0 left-0 w-[40vw] h-[40vw] bg-[#FF94B2] rounded-full blur-[150px] translate-y-1/2 -translate-x-1/2 opacity-30" />
      </div>
      ...
      <div className="max-w-[1400px] w-full px-4 sm:px-6 lg:px-16 flex flex-col lg:flex-row items-center justify-between gap-0 sm:gap-6 lg:gap-16 relative z-10 h-auto">
          ...
          >
            ...
            >
              <video
                ...
                data-src="/Website/Motion Graphic/Motion Graphics Iphone Mockup.mp4"
                autoPlay
                loop
                muted
                playsInline
        ...
        <div className="flex flex-col justify-center items-center lg:items-end text-center lg:text-right gap-8 lg:gap-10 w-full lg:w-[55%] order-1 lg:order-2 animate-fadeIn overflow-hidden">
          ...
          >
            <h2
              className="text-[clamp(3.2rem,8.5vw,8.5rem)] font-gampolins uppercase tracking-tighter leading-[0.8] italic select-none bg-gradient-to-b from-[#FFFFFF] via-[#FF2D55] to-[#8E0E22] bg-clip-text text-transparent origin-right drop-shadow-[0_0_25px_rgba(255,45,85,0.35)] pr-4 sm:pr-6 lg:pr-0"
              style={{
            ...
            <div className="space-y-2 sm:space-y-3 lg:space-y-4">
              ...
              <p className="text-gray-400 text-[clamp(0.85rem,1.1vw,1rem)] font-medium tracking-wide leading-relaxed max-w-[550px]">
                I specialize in creating high-impact motion graphics and visual animations that bring static designs to life, ensuring every frame tells a story.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="rounded-[2rem] p-[2px] bg-gradient-to-r from-[#FF94B2] via-[#E5203A] to-[#FF94B2] shadow-[0_0_40px_rgba(255, 148, 178, 0.15)] transition-all group-hover:shadow-[0_0_60px_rgba(255, 148, 178, 0.25)]">
              <div className="relative w-full h-[clamp(90px,12vh,110px)] lg:h-[220px] overflow-hidden rounded-[1.9rem] bg-black">
                <video
                  ref={timelineVideoRef}
                  data-src="/Website/Motion Graphic/Time line.mp4"
